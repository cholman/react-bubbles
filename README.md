...
- [x] What steps can you take in your web apps to keep your data secure?
    ...
    use https don't store passwords in plain text

- [x] Describe how web servers work.

    servers are computers that are connected to the internet and serve and/or recieve data from other computers
